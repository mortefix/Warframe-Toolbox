...
QToolTip {{
    background: {t.PANEL};
    color: {t.TEXT};
    border: 1px solid {t.FIELD_EDGE};
    padding: 4px 6px;
}}

/* ---- text roles ------------------------------------------------------- */
QLabel[role="h1"]      {{ {h1}    color: {t.TEXT}; }}
QLabel[role="h2"]      {{ {h2}    color: {t.TEXT}; }}
...
QLabel[role="badge"]   {{ {badge} font-weight: bold; }}
...
/* ---- surfaces --------------------------------------------------------- */
QWidget[surface="tab"]     {{ background: {t.TAB_BG}; }}
...
QWidget[surface="console"] {{ background: {t.CONSOLE_BG};
                              color: {t.CONSOLE_FG}; }}
QFrame[surface="hairline"] {{ background: {t.HAIRLINE};
                              border: none; max-height: 1px; }}
QFrame[surface="vline"] {{ background: {t.HAIRLINE};
...
QPushButton[kind="danger"] {{
    ...
    color: {t.TEXT};
    border: 1px solid {t.WFM_RED_DIM};
}}
...
QScrollBar:vertical {{
    background: {t.TAB_BG};
    width: 12px; margin: 0; border: none;
}}
QScrollBar::handle:vertical {{
    background: {t.PANEL_HI}; min-height: 30px; border-radius: 3px;
}}
QScrollBar::handle:vertical:hover   {{ background: {t.GOLD_DIM}; }}
QScrollBar::handle:vertical:pressed {{ background: {t.ACCENT}; }}
QScrollBar:horizontal {{
    background: {t.TAB_BG}; height: 12px; margin: 0; border: none;
}}
QScrollBar::handle:horizontal {{
    background: {t.PANEL_HI}; min-width: 30px; border-radius: 3px;
}}
...
QLabel[nav="icon"] {{ {icon} color: {t.MUTED};
