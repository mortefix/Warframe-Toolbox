...
from ui.widgets import (Finial, hairline, label, logo_pixmap,  # noqa: E402
                        panel, restyle, vline)
...
NAV_SECTION_BORDER = 1       # the gold border, per side
...
class MainWindow(QWidget):
    def __init__(self) -> None:
        ...
        crest = QLabel()
        crest.setPixmap(logo_pixmap(22))
        crest.setStyleSheet("background: transparent;")
        hl.addWidget(crest)
        self.title = label("", role="h2")
